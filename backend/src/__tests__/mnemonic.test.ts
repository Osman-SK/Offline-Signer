...
describe('Mnemonic Import', () => {
  ...
  describe('deriveAddressesFromMnemonic', () => {
    ...
    it('should derive different addresses with different passphrases', () => {
      const addressesNoPass = keyManager.deriveAddressesFromMnemonic(
        VALID_MNEMONIC_12,
        '',
        'backpack',
        '',
      ...
      const addressesWithPass = keyManager.deriveAddressesFromMnemonic(
        VALID_MNEMONIC_12,
        'my-passphrase',
        'backpack',
        '',
    ...
    it('should throw error for invalid mnemonic', () => {
      expect(() => {
        keyManager.deriveAddressesFromMnemonic(
          INVALID_WORD_COUNT,
          '',
          'backpack',
          '',
